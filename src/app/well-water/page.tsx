...
export const metadata: Metadata = {
  ...
  description:
    "Private wells in the Treasure Valley are not treated at a city plant. Hardness, iron stains, sulfur smell, sediment, and taste are common reasons for whole-home filtration.",
...
const reasons = [
  ...
  },
  {
    ...
    body: "Cloudy water, grit in screens, or a metallic or off taste are reasons people treat the whole house rather than one faucet.",
  },
  {
  ...
  return (
    <>
      <PageHero
        ...
        lede={`Homes on private wells in ${site.areaLong} do not receive city-treated water. Whole-home filtration is how sediment, hardness, iron, sulfur, and taste or odor are handled at every tap.`}
      />
      ...
      <section className="mx-auto max-w-6xl px-4 py-14 sm:px-6">
        ...
        <aside className="mt-10 max-w-2xl rounded-2xl bg-sand p-6 sm:p-8">
          ...
          <p className="mt-3 leading-relaxed text-muted">
            ...
            site is for water filtration and treatment.
          </p>
        </aside>
      </section>
